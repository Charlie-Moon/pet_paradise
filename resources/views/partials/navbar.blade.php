<nav class="navbar fixed-top align-items-start navbar-expand-lg ps-0 pe-0 py-0" >
    ...
    <div class="collapse navbar-collapse" id="top-navigation">
        ...
        <ul class="navbar-nav ms-auto pe-3 flex-row">
            @if (app('impersonate')->isImpersonating())
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu mt-1 end-0 p-0" aria-labelledby="navbarDropdown" style="left: unset">
